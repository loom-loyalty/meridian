...
export const DEFAULT_WEIGHT_PROFILE: Required<Omit<WeightProfile, "id">> & { id: "default" } = {
  id: "default",
 ...
 */
export const INFRA_WEIGHT_PROFILE: Required<Omit<WeightProfile, "id">> & { id: "infra" } = {
  id: "infra",
 ...
 */
export const PRODUCT_WEIGHT_PROFILE: Required<Omit<WeightProfile, "id">> & { id: "product" } = {
  id: "product",
...
export function resolveWeightProfile(
  id: string | undefined
): typeof DEFAULT_WEIGHT_PROFILE | typeof INFRA_WEIGHT_PROFILE | typeof PRODUCT_WEIGHT_PROFILE {
  switch (id) {
    case "infra":
